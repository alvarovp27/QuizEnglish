    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch(listTypes){
            case ALL:
                ...
                //Comportamiento del boton de fav
                favButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (favList.contains(word)) {
                            ...
                            db.close();
                            favButton.setImageResource(R.drawable.ic_non_fav);
                            notifyDataSetChanged(); //Refresca la ListView tras cambiar alg�n elemento
                        } else {
                            WordsDB db = new WordsDB(context);
            ...
            case FAVOURITES:
                ...
                //Comportamiento del bot�n de fav
                favButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (favList.contains(favouriteWord)) {
            ...
            case WORST:
                ...
                //No deber�a ser necesario hacer esto, pero si no no pilla que WordStat hereda de
                //Word. Algo raro ocurre ah�.
